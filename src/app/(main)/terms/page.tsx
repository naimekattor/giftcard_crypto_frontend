        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-[3rem] shadow-xl p-10 md:p-16 border border-slate-100">
            ...
            <div className="prose prose-slate max-w-none text-slate-600 space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-black text-slate-900 mb-4">4. Transactions & Cryptocurrency</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-black text-slate-900 mb-4">5. Dispute Resolution</h2>
                <p>
