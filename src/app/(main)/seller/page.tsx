...
import { ShieldCheck, CircleCheck, Zap, Lock } from "lucide-react";
...
export default function SellerPage() {
      ...
      <div className="bg-white border-b border-slate-200 pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto font-medium">
            Convert your unused gift cards into cryptocurrency instantly. No
            account, no KYC, no hassle.
          </p>
        </div>
      </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-medium leading-relaxed">
                    No ID needed. Your privacy is our priority.
                  </p>
                </div>
              </div>
  ...
  <div
    ...
    style={{ backgroundColor: 'rgba(1, 170, 136, 0.1)' }}
  >
  ...
  <div>
    ...
    <p className="text-sm text-slate-500 font-medium leading-relaxed">
      Your gift card will go live shortly after submission, once validated.
      This can take up to 12 hours, but varies depending on the gift card you submit.
    </p>
  </div>
</div>
  ...
  >
    <Zap className="w-6 h-6" style={{ color: '#E86F24' }} />
  </div>
  ...
  <div>
    ...
    <p className="text-sm text-slate-500 font-medium leading-relaxed">
      Crypto is transferred into your wallet within as little as 30 minutes.
    </p>
  </div>
</div>
            </div>
